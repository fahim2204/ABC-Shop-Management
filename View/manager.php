    ...
    <table style="width:100%" >
            <tr style="vertical-align:top">
                <td width = "18%"> 
                    ...
                    <?php $menu2 = new MenuBar("Add Employee", "?page=addEmployee", "https://img.icons8.com/carbon-copy/20/000000/womens-suit.png");?> 
                    ...
                    <?php $menu5 = new MenuBar("Manage Customer", "?page=addCategory", "https://img.icons8.com/dotty/20/000000/mobile-home.png");?> 
                    <?php $menu6 = new MenuBar("Add Category", "?page=addUser", "https://img.icons8.com/ios-filled/20/000000/coffee.png");?> 
                    <?php $menu7 = new MenuBar("Mange Salesman", "?page=manageSalesman", "https://img.icons8.com/ios-filled/20/000000/orange-juice.png");?> 
                    <?php $menu8 = new MenuBar("Purchase", "?page=purchase","https://img.icons8.com/ios-glyphs/20/000000/sweet-halloween-candy.png");?> 
                    <?php $menu9 = new MenuBar("Manage Delivery Man", "?page=mangeDeliveryMan", "https://img.icons8.com/pastel-glyph/20/000000/citrus.png");?> 
