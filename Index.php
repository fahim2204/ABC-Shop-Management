    ...
    <table style="width:100%" >
            <tr style="vertical-align:top">
                <td width = "16%" rowspan="2"> 
                    <?php $menu1 = new MenuBar("Our Own Product", "fish.php", "https://img.icons8.com/pastel-glyph/20/000000/shop--v2.png");?> 
            ...
            <tr> 
                <td width = "21%">
                    <?php $product1 = new Product("Head Phone", "1 piece", "1.jpg", "3000");?> 
                    <?php $product2 = new Product("Watch", "1 piece", "2.jpg", "5500");?> 
                    <?php $product3 = new Product("Coco Oil", "250ml", "3.jpg", "180");?> 
                    <?php $product4 = new Product("Red Leather Bag", "1 piece", "4.jpg", "1800");?> 
                </td>
                <td width = "21%">
                    <?php $product1 = new Product("Head Phone", "1 piece", "5.jpg", "3000");?> 
                    <?php $product2 = new Product("Watch", "1 piece", "9.jpg", "5500");?> 
                    <?php $product3 = new Product("Coco Oil", "250ml", "3.jpg", "180");?> 
                    <?php $product4 = new Product("Red Leather Bag", "1 piece", "1.jpg", "1800");?> 
                </td>
                <td width = "21%">
                    <?php $product1 = new Product("Head Phone", "1 piece", "6.jpg", "3000");?> 
                    <?php $product2 = new Product("Watch", "1 piece", "3.jpg", "5500");?> 
                    <?php $product3 = new Product("Coco Oil", "250ml", "8.jpg", "180");?> 
                    <?php $product4 = new Product("Red Leather Bag", "1 piece", "2.jpg", "1800");?> 
                </td>
                <td width = "21%">
                    <?php $product1 = new Product("Head Phone", "1 piece", "7.png", "3000");?> 
                    <?php $product2 = new Product("Watch", "1 piece", "4.jpg", "5500");?> 
                    <?php $product3 = new Product("Coco Oil", "250ml", "3.jpg", "180");?> 
                    <?php $product4 = new Product("Red Leather Bag", "1 piece", "9.jpg", "1800");?> 
                </td>
            </tr>
        </table>
    </body>
